...
urlpatterns = [
    ...
    path(
        "ticket/modification/<int:ticket_pk>",
        login_required(tickets_views.update_ticket),
        name="ticket_update",
    ),
    path(
        "ticket/<int:ticket_pk>/review/",
        login_required(tickets_views.new_review),
        name="ticket_review_create",
    ),
    path(
        "ticket/<int:id_post>/delete/",
    ...
    path(
        "review/modification/<int:review_pk>",
        login_required(tickets_views.update_review),
        name="review_update",
    ),
    path(
        "review/<int:id_post>/delete/",
        login_required(tickets_views.delete_post),
        name="delete_review",
    ),
